...
const Footer = () => {
  return (
    <div className="w-screen mx-auto py-16 px-28 grid lg:grid-cols-3 gap-8 text-gray-300 bg-[#25274d] cool">
      <div>
        <h1 className="w-full text-3xl font-bold text-[#00df9a]">Med EasZ</h1>

        <div className="flex justify-between md:w-[75%] my-6 ">
          <a href="https://www.instagram.com/athang_yende84/">
            <FaInstagram size={40} />
          </a>
          <a href="">
            <FaTwitterSquare size={40} />
          </a>
          <a href="https://github.com/athang12">
      ...
      <div className="lg:col-span-2 flex justify-between mt-6 text-center">
        ...
        <div>
          ...
          <ul>
            <li className="py-2 text-sm">
              <Link to="/coming-soon">Claim</Link>
            </li>
            <li className="py-2 text-sm">
              <Link to="/coming-soon">Policy</Link>
            </li>
            <li className="py-2 text-sm">
